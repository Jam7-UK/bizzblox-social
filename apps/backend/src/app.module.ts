...
import { shouldRegisterPostizStartupHooks } from '@gitroom/backend/bizzblox/bizzblox-startup-policy';
...
@Module({
  imports: [
    ...
    ...(shouldRegisterPostizStartupHooks(process.env.BIZZBLOX_SERVICE_MODE)
      ? [
